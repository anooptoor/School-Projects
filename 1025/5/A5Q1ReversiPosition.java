 ...
 */
public class A5Q1ReversiPosition {
	 ...
	 */
	public A5Q1ReversiPosition(int nrows, int ncols) {
	 ...
	 * @return the copy.
	 */
	public A5Q1ReversiPosition copy() {
		A5Q1ReversiPosition newpos = new A5Q1ReversiPosition(_nrows, _ncols);
		copyInto(newpos);
		return newpos;
	}
	/**
	 ...
	 */
	public void copyInto(A5Q1ReversiPosition other) {
